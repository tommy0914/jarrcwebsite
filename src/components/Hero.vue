...
<template>
  <section id="home" class="bg-[#f8f9f8] px-6 md:px-12 pt-12 pb-20 md:pb-32 relative overflow-hidden">
    ...
    <div class="absolute right-0 top-[2%] w-[400px] md:w-[600px] h-[400px] md:h-[600px] bg-[#4ade80] rounded-full z-0 pointer-events-none translate-x-[45%] shadow-[-15px_15px_60px_-15px_rgba(0,0,0,0.15)] animate-float"></div>

    <div class="max-w-6xl mx-auto flex flex-col items-end text-right relative z-10 md:pr-80">
      <h1 class="font-['Cakra'] font-normal text-[32px] md:text-[50px] leading-[1.2] md:leading-[70px] tracking-normal text-gray-900 mb-8 md:mb-12 max-w-4xl text-right overflow-hidden">
        <span class="block animate-fade-in-up opacity-0" style="animation-delay: 0.2s">BUILD POWERFUL DIGITAL</span>
        <span class="block animate-fade-in-up opacity-0" style="animation-delay: 0.5s">EXPERIENCES FOR MODERN</span>
        <span class="block animate-fade-in-up opacity-0" style="animation-delay: 0.8s">BUSINESSES</span>
      </h1>
      
      <div class="flex flex-col md:flex-row items-center justify-between w-full mt-12 md:mt-48 gap-10">
        <div class="flex-1 text-right max-w-full md:max-w-[346px] font-['Poppins'] font-normal text-[16px] md:text-[18px] leading-[1.4] tracking-normal text-gray-600 animate-fade-in-up opacity-0" style="animation-delay: 1.2s">
           <p>
    ...
    <div class="max-w-6xl mx-auto mt-20 md:mt-40 lg:mt-64 grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-16 lg:gap-20 items-center relative z-10">
      ...
      <div class="relative h-auto lg:h-[396.88px] flex items-center w-full overflow-visible">
         <div class="relative lg:absolute lg:-right-[130px] w-full lg:w-[832.88px] h-auto lg:h-[396.88px] border-[1.23px] border-[#42DD75B2] rounded-[30px] lg:rounded-[50%] flex flex-col items-center justify-center p-6 md:p-8 lg:p-0 opacity-100 bg-white lg:bg-transparent"
              style="top: 0.56px; left: 0.56px;">
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-x-8 md:gap-x-12 gap-y-3 md:gap-y-4 w-full md:w-[600px] lg:h-[131px] lg:pl-4">
              <div class="flex items-center gap-2 text-gray-700 sm:whitespace-nowrap" style="font-family: 'Inter'; font-weight: 400; font-style: normal; font-size: 15.18px; line-height: 23.61px; letter-spacing: 0%; vertical-align: middle;">
                 <span class="text-green-500 text-[12px]">&#x2726;</span> Reliable Development
              </div>
              <div class="flex items-center gap-2 text-gray-700 sm:whitespace-nowrap" style="font-family: 'Inter'; font-weight: 400; font-style: normal; font-size: 15.18px; line-height: 23.61px; letter-spacing: 0%; vertical-align: middle;">
                 <span class="text-green-500 text-[12px]">&#x2726;</span> Business Digital Transformation
              </div>
              <div class="flex items-center gap-2 text-gray-700 sm:whitespace-nowrap" style="font-family: 'Inter'; font-weight: 400; font-style: normal; font-size: 15.18px; line-height: 23.61px; letter-spacing: 0%; vertical-align: middle;">
                 <span class="text-green-500 text-[12px]">&#x2726;</span> Modern UI Design
              </div>
              <div class="flex items-center gap-2 text-gray-700 sm:whitespace-nowrap" style="font-family: 'Inter'; font-weight: 400; font-style: normal; font-size: 15.18px; line-height: 23.61px; letter-spacing: 0%; vertical-align: middle;">
                 <span class="text-green-500 text-[12px]">&#x2726;</span> Business Growth Solutions
              </div>
              <div class="flex items-center gap-2 text-gray-700 sm:whitespace-nowrap" style="font-family: 'Inter'; font-weight: 400; font-style: normal; font-size: 15.18px; line-height: 23.61px; letter-spacing: 0%; vertical-align: middle;">
                 <span class="text-green-500 text-[12px]">&#x2726;</span> Branding
              </div>
              <div class="flex items-center gap-2 text-gray-700 sm:whitespace-nowrap" style="font-family: 'Inter'; font-weight: 400; font-style: normal; font-size: 15.18px; line-height: 23.61px; letter-spacing: 0%; vertical-align: middle;">
                 <span class="text-green-500 text-[12px]">&#x2726;</span> Tech Support
              </div>
            </div>
         </div>
      </div>
